...
<body>
	<h3 align="center">编辑项目</h3>
	<form action="<c:url value='/ProjectServlet'/>" method="post">
		<input type="hidden" name="method" value="edit"> <input
			type="hidden" name="pid" value="${project.pid }" />
		<table border="0" align="center" width="40%"
			style="margin-left: 100px;">
			<tr>
				<td width="100px">项目名称</td>
				<td width="40%"><input type="text" name="pname"
					value="${project.pname }" /></td>
				<td align="left"><label id="pnameError" class="error">&nbsp;</label>
				</td>
			</tr>

			<tr>
				<td width="100px">负责人</td>
				<td width="40%"><input type="text" name="principal"
					value="${project.principal }" /></td>
				<td align="left"><label id="principalError" class="error">&nbsp;</label>
				</td>
			</tr>

			<tr>
				<td width="100px">项目总价</td>
				<td width="40%"><input type="text" name="tprice"
					value="${project.tprice }" /></td>
				<td align="left"><label id="tpriceError" class="error">&nbsp;</label>
				</td>
			</tr>

			<tr>
				<td width="100px">项目余额</td>
				<td width="40%"><input type="text" name="balance"
					value="${project.balance }" /></td>
				<td align="left"><label id="balanceError" class="error">&nbsp;</label>
				</td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="deadline" id="deadline"
					readonly="readonly" value="${project.deadline }" /></td>
				<td><label id="deadlineError" class="error">&nbsp;</label></td>
			</tr>

			<tr>
				<td>&nbsp;</td>
				<td><input type="button" value="编辑项目" onclick="add()" /> <input
